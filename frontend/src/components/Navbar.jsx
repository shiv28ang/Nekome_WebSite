...
//     return (
//         <nav className={'flex flex-wrap ${containerStyles} gap-x-8'}>
...
//             <a href={'#contact'} onClick={()=> setisActive("contact")}className={isActive==="contact"?"active-link":""}><div className='flexCenter gap-x-1'><MdContacts/>Contact Us</div></a>
//         </nav>
//     )
// }
...
const Navbar = ({ containerStyles }) => {
  const [isActive, setIsActive] = useState("home");
  return (
    <nav className={`flex ${containerStyles} gap-x-8`}>
      ...
      <a href="#contact" onClick={() => setIsActive("contact")} className={isActive === "contact" ? "active-link" : ""}>
        <div className="flexCenter gap-x-1">
