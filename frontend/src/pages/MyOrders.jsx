            ...
            <table className='w-full mt-8'>
                <thead>
                    <tr className='border-b border-slate-900/20 text-gray-30 regular-14 xs:regular-16 text-start py-12'>
                        <th className='p- text-left hidden sm:table-cell'>Package</th>
                        <th className='p- text-left '>Title</th>
                        <th className='p- text-left'>Price</th>
                        <th className='p- text-left'>Quantity</th>
                        <th className='p- text-left'>Status</th>
                        <th className='p- text-left'>Track</th>
                    </tr>
                </thead>
                <tbody>
                    {
                            ...
                            <tr key={i} className='border-b border-slate-900/20 text-gray-50 p-6 medium-14 text-left'>
                                ...
                                <td className='p-1' >
                                    <p>{order.items.map((item,index)=>{
                                        if(index===order.items.length- text-left)
                                        {
